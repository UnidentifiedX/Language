...
namespace Language.Tests.CodeAnalysis.Syntax
{
    public class LexerTest
    {
        ...
        public void Lexer_Lex_TokenPairs(SyntaxKind t1Kind, string t1Text, SyntaxKind t2Kind, string t2Text)
        {
            ...
            var tokens = SyntaxTree.ParseTokens(text, true).ToArray();
        ...
        public void Lexer_Lex_TokenPairs_WithSeparators(SyntaxKind t1Kind, string t1Text, 
                                                        SyntaxKind separatorKind, string separatorText, 
                                                        SyntaxKind t2Kind, string t2Text)
        {
            var text = t1Text + separatorText + t2Text;
            var tokens = SyntaxTree.ParseTokens(text, false).ToArray();
        ...
        public static IEnumerable<(SyntaxKind kind, string text)> GetTokens()
        {
            return new[]
            {
                ...
                (SyntaxKind.InequalityToken, "is not equal to"),
