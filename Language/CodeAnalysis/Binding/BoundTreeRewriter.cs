...
namespace Language.CodeAnalysis.Binding
{
    internal abstract class BoundTreeRewriter
    {
        ...
        protected virtual BoundStatement RewriteBlockStatement(BoundBlockStatement node)
        {
            ...
            {
                var oldStateemt = node.Statements[i];
                var newStatement = RewriteStatement(oldStateemt);
                if(newStatement != oldStateemt)
                {
                    if(builder == null)
                    {
        ...
        protected virtual BoundExpression RewriteBinaryExpression(BoundBinaryExpression node)
        {
            ...
            return new BoundBinaryExpression(node.Left, node.Op, node.Right);
        }
    }
}
